...
@mixin mat-datepicker-theme($theme) {
  ...
  .mat-calendar-body-today {
    ...
    &.mat-calendar-body-selected {
      box-shadow: inset 0 0 0 $mat-datepicker-selected-today-box-shadow-width mat-color($primary, default-contrast);
    }
  }
...
@mixin _mat-form-field-label-floating($font-scale, $infix-padding, $infix-margin-top) {
  ...
  // translateZ fixes.
  transform: translateY(-$infix-margin-top - $infix-padding) scale($font-scale) perspective(100px) translateZ(0.001px + $dedupe);
